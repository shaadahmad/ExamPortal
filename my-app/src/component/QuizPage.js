...
function QuizPage({ userData, fetchUsers }) {
    ...
    return Show ? next < userData.length ? (
        ...
        <div className='qBackground'>
            ...
            <div>
                ...
                <form className='quizForm'>
                    ...
                    <br />
                    <br />
                    <button  className='btn-2' onClick={()=>next && setNext(next -1)} type="button">Previous</button>
                    {
                        (next == userData.length - 1) ? <button className='btn-2 ' style={{ marginLeft: "192px" }} onClick={(e) => handleNext()} type="button">End Test</button> : <button className='btn-2' style={{ marginLeft: "192px" }} onClick={(e) => handleNext()} type="button">Next</button>
                    }
                ...
                <div className='pagination'>
                    {
                        pageNumber.map(number => (
                            ...
                            <a   onClick={()=>setNext(number-1)}>{number}</a>
        ...
        <div className='qBackground'>
             <img src={sessionStorage.getItem("image") ? "http://localhost:8000/" + sessionStorage.getItem("image") : "demo.png"} alt="Avatar" class="avatar" style={{ height: "100px" }} />
